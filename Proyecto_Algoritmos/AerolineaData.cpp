...
void AerolineaData::initItinerarios() {
    ...
    Pais* cr=new Pais("CR");
    itinerarios1.push(new Itinerario(cr, new Pais("MX"), "7am-10am", new Avion("Boeing 737", 80)));
    itinerarios1.push(new Itinerario(cr, new Pais("PR"), "10am-1pm", new Avion("Boeing 747", 50)));
    itinerarios1.push(new Itinerario(cr, new Pais("PN"), "3pm-6pm", new Avion("Boeing 787", 70)));
    itinerarios1.push(new Itinerario(cr, new Pais("COL"), "3pm-6pm", new Avion("Boeing 737", 80)));

    this->grafo->agregarAristaYPeso(new Vertice(cr), new Vertice(new Pais("MX")), 3);
    this->grafo->agregarAristaYPeso(new Vertice(cr), new Vertice(new Pais("PR")), 3);
    this->grafo->agregarAristaYPeso(new Vertice(cr), new Vertice(new Pais("PN")), 3);
    this->grafo->agregarAristaYPeso(new Vertice(cr), new Vertice(new Pais("COL")), 3);
    ...
    itinerarios3.push(new Itinerario(cr, new Pais("URU"), "7am-10am", new Avion("Boeing 747", 60)));
    itinerarios3.push(new Itinerario(new Pais("PR"), new Pais("ITA"), "10am-1pm", new Avion("Boeing 737", 80)));
    itinerarios3.push(new Itinerario(cr, new Pais("POR"), "3pm-6pm", new Avion("Boeing 747", 70)));
    itinerarios3.push(new Itinerario(new Pais("NIC"), new Pais("ECU"), "3pm-6pm", new Avion("Boeing 787", 90)));

    this->grafo->agregarAristaYPeso(new Vertice(cr), new Vertice(new Pais("URU")), 3);
    this->grafo->agregarAristaYPeso(new Vertice(new Pais("PR")), new Vertice(new Pais("ITA")), 3);
    this->grafo->agregarAristaYPeso(new Vertice(cr), new Vertice(new Pais("POR")), 3);

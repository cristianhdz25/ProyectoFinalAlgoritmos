...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/proyecto_algoritmos_copy: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/proyecto_algoritmos_copy ${OBJECTFILES} ${LDLIBSOPTIONS} `pkg-config gtkmm-3.0 --libs`
...
${OBJECTDIR}/VentanaDibujo.o: VentanaDibujo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaDibujo.o VentanaDibujo.cpp
...
${OBJECTDIR}/VentanaMostrarVuelos.o: VentanaMostrarVuelos.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VentanaMostrarVuelos.o VentanaMostrarVuelos.cpp

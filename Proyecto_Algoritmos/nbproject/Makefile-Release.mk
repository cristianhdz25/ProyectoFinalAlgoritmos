...
${OBJECTDIR}/RestriccionData.o: RestriccionData.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RestriccionData.o RestriccionData.cpp

${OBJECTDIR}/RestrictionWindow.o: RestrictionWindow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RestrictionWindow.o RestrictionWindow.cpp
